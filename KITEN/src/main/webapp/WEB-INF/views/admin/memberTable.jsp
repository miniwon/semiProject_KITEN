			...
			<div class="menu-sidebar__content js-scrollbar1">
				<nav class="navbar-sidebar">
					<ul class="list-unstyled navbar__list">
						...
						<li class="active"><a href="table.html"> <i class="fas fa-table"></i>Tables
						</a></li>
						<li><a href="form.html"> <i class="far fa-check-square"></i>Forms
						</a></li>
						<li><a href="calendar.html"> <i class="fas fa-calendar-alt"></i>Calendar
						...
						<table class="table table-borderless table-data3">
							...
							<tbody>
								...
								<c:forEach items='${list}' var='member'>
									...
									<form action="memberModify.do" id="memberModify" name="memberModify">
										<tr>
											<td class="checkbox"><input type="checkbox"></td>
											<td><input value="${member.m_number}" id="m_number" name="m_number" readonly></td>
											...
											<td class="table-data-feature">
												...
												</button> <a href="memberDelete.do?m_number=${member.m_number}">
