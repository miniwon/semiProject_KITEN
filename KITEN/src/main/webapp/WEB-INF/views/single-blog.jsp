					...
					<div class="single-post row">
						<div class="col-lg-12">
							<div class="feature-img">
								<img class="img-fluid" src="<%=pjName%>/resources/img/blog/feature-img1.jpg" alt="">
							</div>
						</div>
						...
						<div class="col-lg-9 col-md-9 blog_details">
							...
							<p class="excert">MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study
								materials yourself at a fraction.</p>
							<p>Boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a
								fraction of the camp price. However, who has the willpower to actually sit through a self-imposed MCSE training. who has the willpower to actually sit through a self-imposed</p>
							<p>Boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself at a
								fraction of the camp price. However, who has the willpower to actually sit through a self-imposed MCSE training. who has the willpower to actually sit through a self-imposed</p>
						</div>
						<div class="col-lg-12">
							<div class="quotes">MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study
								materials yourself at a fraction of the camp price. However, who has the willpower to actually sit through a self-imposed MCSE training.</div>
							<div class="row">
								<div class="col-6">
									<img class="img-fluid" src="<%=pjName%>/resources/img/blog/post-img1.jpg" alt="">
								</div>
								<div class="col-6">
									<img class="img-fluid" src="<%=pjName%>/resources/img/blog/post-img2.jpg" alt="">
								</div>
								<div class="col-lg-12 mt-4">
									<p>MCSE boot camps have its supporters and its detractors. Some people do not understand why you should have to spend money on boot camp when you can get the MCSE study materials yourself
					...
					<div class="navigation-area">
						<div class="row">
							<div class="col-lg-6 col-md-6 col-12 nav-left flex-row d-flex justify-content-start align-items-center">
								<div class="thumb">
									<a href="#"> <img class="img-fluid" src="<%=pjName%>/resources/img/blog/prev.jpg" alt="">
									</a>
								</div>
								<div class="arrow">
							...
							<div class="col-lg-6 col-md-6 col-12 nav-right flex-row d-flex justify-content-end align-items-center">
								...
								<div class="thumb">
									<a href="#"> <img class="img-fluid" src="<%=pjName%>/resources/img/blog/next.jpg" alt="">
									</a>
								</div>
							</div>
						</div>
					...
					<div class="comments-area">
						...
						<div class="comment-list">
							<div class="single-comment justify-content-between d-flex">
								<div class="user justify-content-between d-flex">
									<div class="thumb">
										<img src="<%=pjName%>/resources/img/blog/c1.jpg" alt="">
									</div>
									<div class="desc">
										<h5>
						...
						<div class="comment-list left-padding">
							<div class="single-comment justify-content-between d-flex">
								<div class="user justify-content-between d-flex">
									<div class="thumb">
										<img src="<%=pjName%>/resources/img/blog/c2.jpg" alt="">
									</div>
									<div class="desc">
										<h5>
						...
						<div class="comment-list left-padding">
							<div class="single-comment justify-content-between d-flex">
								<div class="user justify-content-between d-flex">
									<div class="thumb">
										<img src="<%=pjName%>/resources/img/blog/c3.jpg" alt="">
									</div>
									<div class="desc">
										<h5>
						...
						<div class="comment-list">
							<div class="single-comment justify-content-between d-flex">
								<div class="user justify-content-between d-flex">
									<div class="thumb">
										<img src="<%=pjName%>/resources/img/blog/c4.jpg" alt="">
									</div>
									<div class="desc">
										<h5>
											<a href="#">Maria Luna</a>
						...
						<div class="comment-list">
							<div class="single-comment justify-content-between d-flex">
								<div class="user justify-content-between d-flex">
									<div class="thumb">
										<img src="<%=pjName%>/resources/img/blog/c5.jpg" alt="">
									</div>
									<div class="desc">
										<h5>
											<a href="#">Ina Hayes</a>
	...
	<section class="instagram_area">
		<div class="container box_1620">
			...
			<div class="instagram_image row m0">
				<a href="#"><img src="<%=pjName%>/resources/img/instagram/ins-1.jpg" alt=""></a> <a href="#"><img src="<%=pjName%>/resources/img/instagram/ins-2.jpg" alt=""></a> <a href="#"><img src="<%=pjName%>/resources/img/instagram/ins-3.jpg" alt=""></a> <a
					href="#"><img src="<%=pjName%>/resources/img/instagram/ins-4.jpg" alt=""></a> <a href="#"><img src="<%=pjName%>/resources/img/instagram/ins-5.jpg" alt=""></a> <a href="#"><img src="<%=pjName%>/resources/img/instagram/ins-6.jpg" alt=""></a>
			</div>
		</div>
	</section>
	<!--================End Instagram Area =================-->
