...
<body>
			...
			<div class="row">
				...
				<div class="col-lg-10">
					<div class="login_form_inner register_form_inner">
						<h3 >${sessionScope.userId} 님 비밀번호를 입력해주세요. </h3>
					<form class="row login_form" action="userRemove.do" id="userRemove" name="userRemove" method= "post">
							
							<div class="col-md-12 form-group">
								<div class="form-label-div">
								<input type="hidden" class="form-control" id="m_id" name="m_id" value= "${sessionScope.userId}">
							...
							<div class="col-md-12 form-group">
								<button type="button" value="submit" class="button button-register w-100" id="d_confirm">탈퇴하기</button>
							</div>
						</form>
						</div>
					</div>
	...
	<script src="<%=pjName%>/resources/js/userRemove.js"></script>
