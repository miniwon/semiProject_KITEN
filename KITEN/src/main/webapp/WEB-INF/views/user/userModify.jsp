			...
			<div class="row">
				...
				<div class="col-lg-10">
					<div class="login_form_inner register_form_inner">
						<h3>회원 정보 수정</h3>
						<form class="row login_form" action="userModify_ok.do" id="usermodify" name="usermodify">
							<div class="col-md-12 form-group">
								<div class="form-label-div">
									<label class="form-label" for="id">아이디</label>
								</div>
								<input type="text" class="form-control" id="m_id" name="m_id" value='${sessionScope.userId}'
									readonly>
							...
							<div class="col-md-12 form-group">
								...
								<input type="text" class="form-control" id="m_name" name="m_name" placeholder="이름을 입력해 주세요" onfocus="this.placeholder = ''" onblur="this.placeholder = '이름을 입력해 주세요'" value = '${member.m_name}' readonly >
								<div class="form-button"></div>
							</div>
							<div class="col-md-12 form-group">
								<div class="form-label-div">
								...
								<input type="email" class="form-control" value = '${member.m_email}' id="m_email" name="m_email" placeholder="예: mealkit@kiten.com" onfocus="this.placeholder = ''" onblur="this.placeholder = '예: mealkit@kiten.com'">
							...
							<div class="col-md-12 form-group">
								...
								<input type="text" class="form-control" id="m_tel" value = '${member.m_tel}' name="m_tel" placeholder="-을 제외한 숫자만 입력해 주세요" onfocus="this.placeholder = ''" onblur="this.placeholder = '-을 제외한 숫자만 입력해 주세요'">
								<div class="form-button"></div>
							</div>
							<div class="col-md-12 form-group">
								<div class="form-label-div">
