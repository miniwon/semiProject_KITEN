...
public class ProductController {
	...
	@RequestMapping("bestProductList.do")
	public void bestProductList(Model model, @RequestParam("num") int num) {
		List<FilterVO> filterList = productService.getFilterCount();
		...
		// 마지막 번호 재계산
		 ...
		 List<ProductVO> list = productService.getProductList(displayPost, postNum);
	...
	public void GG(ProductVO productVO) {
