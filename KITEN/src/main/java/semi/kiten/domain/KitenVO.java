...
public class KitenVO {
	...
	// *************************************************
	MultipartFile file;		//**************************
							// 화면에서 type="file" name="file"이라서 변수명이 file => name 따라 변수명 결정
	...
	public void setFile(MultipartFile file) {
		...
		// 업로드된 파일이 있는 경우
		if (!file.isEmpty()) {
			File f = new File("C:\\springweb\\gWebBoard1\\src\\main\\webapp\\resources\\upload\\"+ b_realfname);
