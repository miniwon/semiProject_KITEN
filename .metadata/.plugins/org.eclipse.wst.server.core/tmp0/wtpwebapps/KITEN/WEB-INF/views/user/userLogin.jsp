			...
			<div class="row">
				<div class="col-lg-6">
					<div class="login_box_img">
						<div class="hover">
							<h4>아직 KITEN 아이디가 없으십니까?</h4>
							<p>회원 가입을 하고 많은 헤택을 누려 보세요!</p>
							<a class="button button-account" href="userJoin.do">회원 가입 바로 가기</a>
						</div>
					</div>
				</div>
				<div class="col-lg-6">
					<div class="login_form_inner">
						<h3>로그인</h3>
						<form class="row login_form" action="login.do" id="loginForm" name="loginForm" method="post">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="m_id" name="m_id" placeholder="아이디를 입력하세요" onfocus="this.placeholder = ''" onblur="this.placeholder = '아이디를 입력하세요'">
							</div>
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" id="m_password" name="m_password" placeholder="비밀번호를 입력하세요" onfocus="this.placeholder = ''" onblur="this.placeholder = '비밀번호를 입력하세요'">
							</div>
							<div class="col-md-12 form-group"></div>
							<div class="col-md-12 form-group">
								<button type="button" value="submit" id="loginButton" name="loginButton" class="button button-login w-100">로그인</button>
								<ul class="loginul">
									<li class="loginli2"><a class="login-link" href="">아이디 찾기</a></li>
									<li class="loginli2"><a class="login-link" href="">비밀번호 찾기</a></li>
								</ul>
							</div>
						</form>
					</div>
