...
<body>
	...
	<script src="<%=pjName%>/resources/vendors/jquery.form.js"></script>
	<script src="<%=pjName%>/resources/vendors/jquery.validate.min.js"></script>
	<script src="<%=pjName%>/resources/vendors/contact.js"></script>
